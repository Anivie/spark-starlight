...
pub(crate) const FAR_POINT_Y_THRESHOLD_FACTOR: f32 = 0.40; // If farthest point's Y > 40% of height, it's "close"
                                                           // Threshold 2: Minimum number of centerline points to be considered "continuing"
pub(crate) const MIN_POINTS_FOR_CONTINUATION: usize = 5; // Needs tuning
